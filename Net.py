...
PHOST = '10.8.3.8'
PPORT = 80
pay1 = '[NET][CLC][CL]GET / [P1] 200 OK[CL]Host: 123.xl.co.id/min_balance7/thankyou.php[CL]X-Online-Host: download.cdn.oly-eu.blackberry.com[CL2]'
pay2 = ''
...
class TCPTunel(Thread):
    if (len(sys.argv)<2):
        os.system('clear')
        slowprint(G +'+ Usage: python net.py <listenport>')
        time.sleep(2)
        os.system('clear')
        slowprint(C +'+ Example: python sdcard/net.py 8989')
        time.sleep(2)
        os.system('clear')
        exit()
